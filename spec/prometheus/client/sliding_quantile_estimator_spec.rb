...
describe Prometheus::Client::SlidingQuantileEstimator do
    ...
    describe '#windows' do
      ...
      it 'expires with interspersed samples'do
        ...
        s6 = [19, 20, 21, 22].each { |s| subject.observe(s) }
        ...
        s7 = [23, 24].each { |s| subject.observe(s) }
        ...
        s8 = [25, 26].each { |s| subject.observe(s) }
        ...
        s9 = [27, 28].each { |s| subject.observe(s) }
        ...
        s10 = [29, 30.5, 31].each { |s| subject.observe(s) }
        ...
        s11 = [32, 33.5, 34, 35, 36].each { |s| subject.observe(s) }
